...
<body>
	<section class="home">
		<div class="in-flex">
			<div id="header">
				<a href="https://fedenoodt.github.io/798326_Epsilon/BHSIAI.html" target="_blank"><img class="Emblema" src="Emblema.PNG"></a>
				<div class = "atajos">
				...
				<hr />		
					<ul>
						<li class="listaHorizontal"><div><a href="https://fedenoodt.github.io/Pagina_personal/PyC/proyectoEE.html#nota5" target="_blank"><p class = "notGood">Receso de urgencia: 1/1 [ 17-08-2022 ]</p></a></div></li>
						<li class="listaHorizontal"><div><a href=""><p class = "good">Incorporaci&oacute;n de contenidos JavaScript seg&uacute;n jornada anual: <br />Tiempo transcurrido: 16.03%. <br />Lectura oficial de contenido: 79.87%. <br />Incorporaci&oacute;n pr&aacute;ctica de contenido: 0%.</p></a></div></li>
						<li class="listaHorizontal"><div><a href=""><p class = "good">Clases Javascript de Coder House: 1/17 (5.9%).</p></a></div></li>
					</ul>
				<hr />
			</div>
		</div>
