...
function launching (event) {
    ...
    Total: ${number} <br />
      •  Capital (${ahorros}%): ${porcent(number, ahorros)}.<br /><br />
        ...
        En el caso de que haya deudas que hayan ido a mayores, este ${refuerzo}% (${porcent (refuerzo, number)}) del ahorro de "dirección múltiple" está dispuesto a brindar esa 
